...
//	protected List<Integer> maxFlipsValues = new ArrayList<Integer>();
//	public void setMaxWalkSatMaxFlipsValues(List<Integer> maxFlipsValues) {
//		this.maxFlipsValues = maxFlipsValues;
//	}
//	
//	protected List<Double> noiseValues = new ArrayList<Double>();
//	public void setMaxWalkSatNoiseValues(List<Double> noiseValues) {
//		this.noiseValues = noiseValues;
//	}
//	
//	/* BooleanMCSat options */
//	protected List<Integer> numSamplesValues = new ArrayList<Integer>();
//	public void setMCSatNumSamplesValues(List<Integer> numSamplesValues) {
//		this.numSamplesValues = numSamplesValues;
//	}
//	
//	protected List<Double> burnInFractions = new ArrayList<Double>();
//	public void setMCSatBurnInFractions(List<Double> burnInFractions) {
//		this.burnInFractions = burnInFractions;
//	}
